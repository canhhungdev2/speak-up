  ...
  template: `
    <div class="min-h-screen bg-gray-50 dark:bg-[#0f172a] flex transition-colors duration-500 font-sans">
      ...
      <aside [class.translate-x-0]="isMobileMenuOpen()" 
        ...
        <!-- Logo -->
        <div class="flex items-center gap-3 mb-12" [class.justify-center]="isSlim">
          ...
          <span *ngIf="!isSlim" class="text-2xl font-black text-gray-900 dark:text-white tracking-tighter font-outfit whitespace-nowrap">SpeakUp</span>
        </div>

        <!-- Navigation Groups -->
        <div class="space-y-8 flex-grow overflow-y-auto pr-2 scrollbar-hide">
          <div>
            <p *ngIf="!isSlim" class="text-[10px] font-black text-gray-400 dark:text-slate-500 uppercase tracking-[0.2em] mb-6 px-4">Menu Chính</p>
            <nav class="space-y-2">
              <a routerLink="/learner" routerLinkActive="bg-primary/10 text-primary dark:bg-primary/20" [routerLinkActiveOptions]="{exact: true}"
                 [title]="isSlim ? 'Dashboard' : ''"
        ...
        <div class="pt-8 border-t border-gray-100 dark:border-white/5 space-y-4">
           <button (click)="themeService.toggleTheme()" 
                   ...
                   [class.justify-center]="isSlim">
             <span *ngIf="!isSlim" class="text-sm font-bold text-gray-600 dark:text-slate-300 flex-grow text-left">Chế độ tối</span>
           ...
           <div class="flex items-center gap-4 p-2" [class.justify-center]="isSlim">
      ...
      <div class="flex-grow flex flex-col min-w-0">
        ...
        <header class="h-24 px-8 flex justify-between items-center bg-white/80 dark:bg-[#0f172a]/80 backdrop-blur-md sticky top-0 z-[50] border-b border-gray-100 dark:border-white/5">
           <!-- Search Bar -->
           <div *ngIf="!isSlim" class="relative w-full max-w-md hidden md:block">
           ...
           <div *ngIf="isSlim" class="flex items-center gap-3">
